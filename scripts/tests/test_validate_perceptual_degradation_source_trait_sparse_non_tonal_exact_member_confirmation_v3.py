...
SCRIPT = ROOT / "scripts/validate_perceptual_degradation_source_trait_sparse_non_tonal_exact_member_confirmation_v3.py"
SPEC = importlib.util.spec_from_file_location("validate_sparse_non_tonal_confirmation_v3", SCRIPT)
assert SPEC and SPEC.loader
MODULE = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(MODULE)


class SparseNonTonalExactMemberConfirmationV3ValidatorTest(unittest.TestCase):
    @classmethod
    ...
    def test_committed_audit_replays_from_public_projection(self) -> None:
        ...
        self.assertEqual("abstained", audit["decision"]["terminal_outcome"])
